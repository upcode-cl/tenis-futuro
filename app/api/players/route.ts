...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const player = await createPlayer({
      ...
      bestNationalRanking: body.bestNationalRanking,
      regionalRanking: body.regionalRanking,
      wtnSingles: body.wtnSingles,
      titlesYear: body.titlesYear,
      singlesTitles: body.singlesTitles,
      doublesTitles: body.doublesTitles,
